...
## 📊 투자 환경 스냅샷 (2026-05-26 기준)

- **현재 입장**: 🟢 분할 진입 모드 (5/20 STAY → 5/26 전환)
  - 종전 선언 기대 + 반도체 사이클 → 현금 일부 단계적 투입
  - 3단계: 1차 ₩25~30M(이번 주) → 2차 ₩20~25M(2~3주 후) → 3차 잔여
  - 예비 현금 ₩30M+ 항상 유보
- **5/26 확정 의사결정 (미실행, 체결 대기)**:
  - ISA: 4종 매도 → ₩20M 추가 납입 → TIGER 미국S&P500 100% (~₩41.7M)
  - MetLife 변액보험: 미국주식 70% + 한국가치주식 30%
  - IRP: 옵션 10 현행 유지
  - 본계좌 ₩5M: 삼성전자 소규모 추가 유력
  - 스윙랩: 한미반도체·솔브레인 진입 검토 중
- **확신도 thesis**:
