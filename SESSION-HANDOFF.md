...
## 📊 투자 환경 스냅샷 (2026-05-27 기준)

- **현재 입장**: 🟢 분할 진입 모드 (5/26 전환)
  - 1차 투입 진행 중: ISA 리밸런싱 + MetLife 변경 + LS ELEC·삼성전자 추매 완료
  - 2차: ₩20~25M (2~3주 후, 5/28 장 확인 후 결정)
  - 예비 현금 ₩30M+ 유보
- **5/27 실행 완료**:
...
- **5/28 이후 검토 중 (미실행)**:
  - ISA ₩20M 추가 납입 → S&P500 추가 매수
  - 현대중공업 ₩10M 본계좌 thesis 신규 진입
  - 코미코 pullback 시 진입 검토
  - IRP: 옵션 10 현행 유지
- **확신도 thesis**:
