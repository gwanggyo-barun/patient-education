...
⚠️ **1차 SoT는 `blocks/content/clinic-contact-footer.yaml` (v03)** — 아래 표는 그 요약. 충돌 시 yaml이 이긴다 (2026-06-06 정합화: 본 표의 옛 "평일(월–금)" 표기는 수요일 오후 휴진을 누락한 오류였음).

| 항목 | 값 |
|---|---|
| 의원명 | 광교바른내과 |
| **진료시간** | **월·화·목·금 08:30~18:30 (점심 13:00~14:00) · 수 08:30~13:00 (오후 휴진) · 토 08:30~13:30** · 일·공휴일 휴진 |
...
```html
<div class="contact-card__main">월·화·목·금 08:30~18:30 · 수 08:30~13:00 · 토 08:30~13:30</div>
```
handouts / lab-reports 푸터 (줄바꿈형)도 허용:
```html
<div class="contact-card__value">월·화·목·금 08:30~18:30 · 수 오전만<br>토요일 08:30~13:30</div>
```

⚠️ **금지(과거 오류)**: ①`평일 09:00 ~ 18:30` / `토 09:00 ~ 14:00` (2026-05 4개 덱에서 정정) ②**`평일(월–금) 08:30~18:30` — 수요일 오후 휴진 누락 오기** (2026-06-06 발견, 본 표 자체가 오류였음 — 기존 자료 일괄 점검 필요) ③수원시 영통구·광교중앙로 145·아브뉴프랑·031-217-5878 (옛 오류 주소·전화).
