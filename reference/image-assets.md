...
15. **혈액·혈관 색 — 파랑 금지**: 혈액·적혈구·혈관벽은 빨강/핑크 자연색으로 그린다. cool-blue 팔레트를 맞추려고 혈액·혈관을 파랗게 칠하지 않는다. 동맥+정맥이 함께 나올 때만 빨강 동맥/파랑 정맥이 허용된다 (단독 혈관이 파랑이면 정맥처럼 보여 어색). 플라크·지방은 옐로. 자세히는 SKILL.md Known Gotchas §20.
...
- Anatomical realism overrides the cool-blue palette for living tissue: blood and blood cells must be RED, vessel walls a natural pink/red tissue tone — NEVER blue. Blue is allowed only for a vein when an artery and vein are shown together. Plaque/fat soft yellow.
